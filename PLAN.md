...
1. **Move drivers to userspace libOS** — original plan's biggest deviation; XHCI/HDA/NVMe/PCI/ACPI/GOP all still run in-kernel. Large undertaking — needs a real driver-in-userspace IPC/MMIO-passthrough mechanism first.
