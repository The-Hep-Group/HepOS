...
- **Still a follow-up, not done here**: the large-icon-grid visual reskin (currently a two-pane tree+list, now with real per-type icons — see above) and mouse-wheel scrolling sized to the window — see Next Steps.
